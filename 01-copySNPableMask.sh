...
:'
If you have only one sample, you may skip this step (step 01) AND the next step (step 02).
...
If you have not yet done this, please do so (e.g., using this pipeline: ).
