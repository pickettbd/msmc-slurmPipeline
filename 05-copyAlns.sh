...
They need to be located at data/alns/${SAMPLE_NAME}-pacbio-reads_x_asm-long.bam. This can be a symbolic link. This is what I did:
	mkdir -p data/alns
	cd data/alns
	ln -s /path/to/my/alns.bam sample1-pacbio-reads_x_asm-long.bam
	ln -s /path/to/my/alns.bam.bai sample1-pacbio-reads_x_asm-long.bam.bai
	cd ../..
